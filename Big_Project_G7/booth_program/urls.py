...
urlpatterns = [
    ...
    path('reservation_status/', views.reservation_status, name='reservation_status'),
    path('check_availableTime/<int:program_id>', views.check_availableTime, name='check_availableTime')
]
